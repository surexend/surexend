    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-[#64748B] mt-0.5">
          {data ? `${data.total} transactions · tap a row for full details` : 'Loading…'}
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          className="bg-[#121419] border border-white/10 rounded-xl px-3 py-2 text-sm text-white outline-none cursor-pointer"
        >
          ...
          <div className="flex items-center justify-between text-xs text-[#94A3B8]">
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={page <= 1}
                className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 disabled:opacity-40"
              >
      ...
      {detailId && (
        <AdminTransactionDetailModal id={detailId} onClose={() => setDetailId(null)} />
      )}
    </div>
  )
}